  ...
  return (
    ...
    >
      <AspectRatio ratio={16 / 6} className="relative">
        ...
        />
        <span className="absolute z-[1] top-0 left-0 bg-pink-500 px-3 py-1.5 font-semibold text-sm text-white rounded-tl-md rounded-br-md">
          Total Menu: {restaurant.menuItems.length}
        </span>
      </AspectRatio>
      <div>
